...
/*卡0的PID定义*/
	...
	DEFINE_PID(DSP_PID_RCM)


    DEFINE_PID(DSP_PID_TLPHY)


    DEFINE_PID(UEPS_PID_BASTET)

    /* Added by x00312156 for TLPHY CHR, 2015-01-28,  Begin */
    DEFINE_PID(TLPHY_PID_RTTAGENT)
