...
VOS_VOID QosFcCtrlInit(VOS_VOID)
{
    ...
    #if 0
    g_stQosFcCtrl.ulPktCntLimit = 80;
    g_stQosFcCtrl.ulTimerLen = 50;

    g_stQosFcCtrl.ulRandomDiscardRate = 20;
    g_stQosFcCtrl.ulDiscardRate = 95;

    g_stQosFcCtrl.ulWarningThres = 100;
    g_stQosFcCtrl.ulDiscardThres = 200;
    g_stQosFcCtrl.ulRandomDiscardThres = 250;
    g_stQosFcCtrl.ulRestoreThres = 300;
    #endif
