...
VOS_UINT32                              g_ulOmAcpuToCcpuCnf = 0;
...
VOS_UINT32 OMRL_AcpuHeadProc(OMRL_RCV_CHAN_CTRL_INFO_STRU *pstCtrlInfo, VOS_UINT8 *pucData, VOS_UINT32 ulSize)
{
    ...
    /*lint -e40*/
    OM_ACPU_DEBUG_CHANNEL_TRACE(pstCtrlInfo->enChannel, pucData, ulSize, OM_ACPU_RECV_USB);
    /*lint +e40*/
...
VOS_VOID OmAcpuToCcpuShow(VOS_VOID)
{
    vos_printf("OmAcpuToCcpuShow = %d\r\n",g_ulOmAcpuToCcpuCnf);
