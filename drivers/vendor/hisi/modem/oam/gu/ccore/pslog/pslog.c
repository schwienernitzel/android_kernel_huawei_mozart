                ...
                VOS_UINT32 ulErrNo, VOS_VOID *pRecord, VOS_UINT32 ulLen)
{
    ...
    if(VOS_TRUE == ulfistCallFlag)
    {
        ...
        if(VOS_NULL_PTR != pstSysReset)
        {
            ...
            pstSysReset->stRecordHead.ulInfoLen = sizeof(DRV_MNTN_SYSTEM_RESET_STRU);/* [false alarm]: 屏蔽Fortify错误 */
    ...
    /*lint -e734*/
    ret = Log_IdNParam(LOG_ERRLOG_ID, LOG_SUBMOD_ID_BUTT, LOG_LEVEL_ERROR,
