...
CC_USER_FLAGS   := ${PLAT_FORM_FALG} ${CHIP_BB_TYPE_FALG} -falign-arrays  -DUSP_2_0 -DWTTF_CIPHER_PIPELINE -D__LOG_RELEASE__ -DVOS_VXWORKS=3 -DVOS_OS_VER=VOS_VXWORKS \
...
CC_USER_FLAGS += -mlong-calls -fsigned-char  -fno-strict-aliasing					
