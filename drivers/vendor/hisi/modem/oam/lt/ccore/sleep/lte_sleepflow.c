...
VOS_INT32 TLSLEEP_HwPowerDown(PWC_COMM_MODE_E modeId)
{
    ...
    ret = TLSLEEP_DfsQosUpdate((VOS_INT32)DFS_QOS_ID_DDR_MINFREQ_E, dfs_ddr_req_id, TLSLEEP_DFS_DDR_0M);
    if(ret)
    {
        flag = VOS_SplIMP();
        set_power_status_bit(MSP_DFS_HALT_UPDATE_FAIL);
...
VOS_VOID TLSLEEP_CheckValidChanel(VOS_VOID)
{
    ...
    {
        g_msp_pwrctrl.tlmode_channel.abb_channel_id= (VOS_CHAR)g_msp_pwrctrl.nv_tlmode_chan_para[0].ucABBSwitch;
    }
    else
    {
    ...
    {
        g_msp_pwrctrl.tlmode_channel.rf_channel_id= (VOS_CHAR)g_msp_pwrctrl.nv_tlmode_chan_para[0].ucRFSwitch;
    }
    else
    {
    ...
    {
        g_msp_pwrctrl.tlmode_channel.tcxo_id= (VOS_CHAR)g_msp_pwrctrl.nv_tlmode_chan_para[0].ucTCXOSwitch;
    }
    else
    {
