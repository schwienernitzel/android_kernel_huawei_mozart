...
{ \
    ...
    g_stFtmMntn.stAcore2FtmMsg.astMsg[g_stFtmMntn.stAcore2FtmMsg.ulPtr].ulSlice = BSP_GetSliceValue(); \
...
{ \
    ...
    g_stFtmMntn.stFtm2AcoreMsg.astMsg[g_stFtmMntn.stFtm2AcoreMsg.ulPtr].ulSlice = BSP_GetSliceValue(); \
...
{ \
    ...
    g_stFtmMntn.stFtm2RttMsg.astMsg[g_stFtmMntn.stFtm2RttMsg.ulPtr].ulSlice = BSP_GetSliceValue(); \
...
{ \
    ...
    g_stFtmMntn.stRtt2FtmMsg.astMsg[g_stFtmMntn.stRtt2FtmMsg.ulPtr].ulSlice = BSP_GetSliceValue(); \
...
{ \
    ...
    g_stFtmMntn.stTimeOutMsg.astMsg[g_stFtmMntn.stTimeOutMsg.ulPtr].ulSlice = BSP_GetSliceValue(); \
    g_stFtmMntn.stTimeOutMsg.ulPtr = (g_stFtmMntn.stTimeOutMsg.ulPtr+1)%FTM_MNTN_MSG_MAXNUM; \
}

extern VOS_VOID ftm_help();
extern VOS_VOID ftm_debug(VOS_BOOL bDebug);
extern VOS_VOID ftm_mntn_init();
extern VOS_VOID ftm_mntn_ftmmsginfo();
extern VOS_VOID ftm_mntn_rttmsginfo();
extern VOS_VOID ftm_mntn_timoutinfo();
...
typedef VOS_UINT32 (*PFN_AT_FTM_TIMEOUT_PROC)();
...
EXTERN VOS_UINT32 at_ftm_fcalpddcs_read(VOID* pParam);
