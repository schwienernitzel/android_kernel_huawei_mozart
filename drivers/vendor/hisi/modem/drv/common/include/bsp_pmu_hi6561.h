...
/* 包含GU DrvNvInterface.h会与 drv_nv_def.h冲突，此处直接再定义一次 */
/* NV ID =18001 start, pa power control, pastar config */
typedef struct{
	BSP_U8 papower_ch0[4];/*物理通道0对应频段的PA的供电单元，值为0表示不打开电源，为1表示为pastar供电，为2表示电池供电，[0],[1],[2],[3]分别对应G U L T*/
	BSP_U8 papower_ch1[4];/*物理通道1对应频段的PA的供电单元，值为0表示不打开电源，为1表示为pastar供电，为2表示电池供电，[0],[1],[2],[3]分别对应G U L T*/
