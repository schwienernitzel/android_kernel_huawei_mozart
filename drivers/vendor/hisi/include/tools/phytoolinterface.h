...
/*****************************************************************************
 结构名    : WPHY_TOOL_TAS_PROTECT_STATE_IND_STRU
 结构说明  : TAS迟滞阶段可维可测上报
*****************************************************************************/
typedef struct
{
...
typedef struct
{
    ...
    VOS_UINT16                                  uhwDpdtState;                   /* dpdt状态 */
    VOS_INT16                                   shwAntValueMain;                /* 天线能量 */
    VOS_INT16                                   shwSwitchDelta;                 /* 能量的差 */
    VOS_UINT16                                  uhwCdmaCtrlFlag;                /* cdma外挂标志 */
