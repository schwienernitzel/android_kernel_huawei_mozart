...
VOS_VOID VOS_TimerCtrlBlkInit(VOS_VOID);
...
VOS_UINT32 VOS_TmNow( VOS_UINT32 *pulRetTimeInMillSecHigh,
                      VOS_UINT32 *pulRetTimeInMillSecLow );
...
VOS_UINT32 VOS_GetFirst26MTimer( VOS_VOID );
